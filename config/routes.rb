  ...
  namespace :api do
    namespace :v1 do
        ...
        namespace :customers, only: [:show] do
          ...
          get ':customer_id/favorite_merchant', to: "favorite_merchant/search#show"
        end
        ...
        namespace :merchants, only: [:show] do
          get ':merchant_id/items', to: "items/search#index"
          get ':merchant_id/invoices', to: "invoices/search#index"
        end

        namespace :transactions, only: [:show] do
          get ':transaction_id/invoice', to: "invoices/search#show"
        end
